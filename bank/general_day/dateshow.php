...
<tr>
  <td colspan="2" dir="rtl" width="1575"><table width="100%" cellspacing="0"  border="1" cellpadding="0">
    <tr>
      ...
      <td dir="ltr" width="145"></td>
      <td dir="ltr" width="19"></td>
      <td dir="rtl" width="145">دفــتـــــــر1111111</td>
      <td dir="ltr" width="164"></td>
      <td dir="ltr" width="145"></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td rowspan="2" dir="rtl" width="110">التاريخ</td>
      <td rowspan="2" dir="rtl" width="425">البيـــــــــــــــــــــــــــــــان</td>
      <td colspan="10" dir="rtl" width="820">الموارد  </td>
      <td colspan="2" rowspan="2" dir="rtl" width="164">حـ/البنك إستخدامات</td>
      <td colspan="2" rowspan="2" dir="rtl" width="164">حـ/ البنك  موارد<br /></td>
      <td colspan="6" dir="rtl">الحسابات    المساعدة المدينة</td>
      <td colspan="4" dir="rtl">الحسابات    المساعدة الدائنة</td>
...
$sqlstatment5="SELECT `num_ts`, `num_s`, `year`, `month`, `day`, `data`, `term`, `type_account`, `accounts`, `resources`, `uses`, val, `num_coll` FROM `public` WHERE `type_account`=1
AND `accounts` =1 AND `resources`=1 AND `term`=2 AND
 `month`>= ".$frommonth." AND 
   `month`<= ".$tomonth ." AND
    `day`>= ".$fromday." AND 
	`day` <=".$today." AND
...
$sqlstatment5="SELECT `num_ts`, `num_s`, `year`, `month`, `day`, `data`, `term`, `type_account`, `accounts`, `resources`, `uses`, val, `num_coll` FROM `public` WHERE `type_account`=1
AND `accounts` =1 AND `resources`=2 AND `term`=2 AND `month`>= ".$frommonth." AND 
   `month`<= ".$tomonth ." AND
    `day`>= ".$fromday." AND 
	`day` <=".$today." AND
	 `year`=".$year."";;
...
$sqlstatment5="SELECT `num_ts`, `num_s`, `year`, `month`, `day`, `data`, `term`, `type_account`, `accounts`, `resources`, `uses`, val, `num_coll` FROM `public` WHERE `type_account`=1
AND `accounts` =1 AND `resources`=3 AND `term`=2 AND `month`>= ".$frommonth." AND 
   `month`<= ".$tomonth ." AND
    `day`>= ".$fromday." AND 
	`day` <=".$today." AND
	 `year`=".$year."";
...
$sqlstatment5="SELECT `num_ts`, `num_s`, `year`, `month`, `day`, `data`, `term`, `type_account`, `accounts`, `resources`, `uses`, val, `num_coll` FROM `public` WHERE `type_account`=1
AND `accounts` =1 AND `resources`=4 AND `term`=2 AND `month`> ".$frommonth." AND 
   `month`<= ".$tomonth ." AND
    `day`>= ".$fromday." AND 
	`day` <=".$today." AND
	 `year`=".$year."";
...
$sqlstatment5="SELECT `num_ts`, `num_s`, `year`, `month`, `day`, `data`, `term`, `type_account`, `accounts`, `resources`, `uses`, val, `num_coll` FROM `public` WHERE `type_account`=1
AND `accounts` =1 AND `resources`=5 AND `term`=2 AND `month`>=".$frommonth." AND 
   `month`<= ".$tomonth ." AND
    `day`>= ".$fromday." AND 
	`day` <=".$today." AND
	 `year`=".$year."";
...
$sqlstatment5="SELECT `num_ts`, `num_s`, `year`, `month`, `day`, `data`, `term`, `type_account`, `accounts`, `resources`, `uses`, val, `num_coll` FROM `public` WHERE `type_account`=1
AND `accounts` =3 AND `term`=2 AND `month`>= ".$frommonth." AND 
   `month`<= ".$tomonth ." AND
    `day`>= ".$fromday." AND 
	`day` <=".$today." AND
	 `year`=".$year."";
...
$sqlstatment5="SELECT `num_ts`, `num_s`, `year`, `month`, `day`, `data`, `term`, `type_account`, `accounts`, `resources`, `uses`, val, `num_coll` FROM `public` WHERE `type_account`=1
AND `accounts` =4 AND `term`=2 AND `month`>= ".$frommonth." AND 
   `month`<= ".$tomonth ." AND
    `day`>= ".$fromday." AND 
	`day` <=".$today." AND
	 `year`=".$year."";
...
$sqlstatment5="SELECT `num_ts`, `num_s`, `year`, `month`, `day`, `data`, `term`, `type_account`, `accounts`, `resources`, `uses`, val, `num_coll` FROM `public` WHERE `type_account`=2
AND `accounts` =1 AND `term`=2 AND `month`>= ".$frommonth." AND 
   `month`<= ".$tomonth ." AND
    `day`>= ".$fromday." AND 
	`day` <=".$today." AND
	 `year`=".$year."";
...
$sqlstatment5="SELECT `num_ts`, `num_s`, `year`, `month`, `day`, `data`, `term`, `type_account`, `accounts`, `resources`, `uses`, val, `num_coll` FROM `public` WHERE `type_account`=2
AND `accounts` =2 AND `term`=2 AND `month`>= ".$frommonth." AND 
   `month`<= ".$tomonth ." AND
    `day`>= ".$fromday." AND 
	`day` <=".$today." AND
	 `year`=".$year."";
...
while($i<=8){
$sqlstatment5="SELECT `num_ts`, `num_s`, `year`, `month`, `day`, `data`, `term`, `type_account`, `accounts`, `resources`, `uses`, val, `num_coll` FROM `public` WHERE `type_account`=2
AND `accounts` =$i AND `term`=2 AND `month`>=".$frommonth." AND 
   `month`<= ".$tomonth ." AND
    `day`>= ".$fromday." AND 
	`day` <=".$today." AND
	 `year`=".$year."";
...
$sqlstatment5="SELECT `num_ts`, `num_s`, `year`, `month`, `day`, `data`, `term`, `type_account`, `accounts`, `resources`, `uses`, val, `num_coll` FROM `public` WHERE `type_account`=2
AND `accounts` =9 AND `term`=2 AND `month`>=".$frommonth." AND 
   `month`<= ".$tomonth ." AND
    `day`>= ".$fromday." AND 
	`day` <=".$today." AND
	 `year`=".$year."";
