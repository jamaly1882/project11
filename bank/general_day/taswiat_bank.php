...
<?php
echo'     
    <form action="insert.php"  name="a" method="post" enctype="multipart/form-data" onsubmit="return validate_form()"><table width="700" border="1" >
  ...
  <tr  align="center"  valign="top">
   ...
   <option value="22">حـسـاب  البنـــك حـسـابات الجارية</option>
                         <option value="13">البنك موارد</option>
    
    
    </select></td></tr>
	  <input name="" type="submit"  onclick="insert()"  size="15" value="تخزيــــن" />
