...
//        VALUES('$num_form')") or die (mysqli_error($sss));
		...
		IF($gm=="uses_ts_tb"&&$gd=="uses_ts_tb"){
			$query = mysqli_query($sss, "INSERT INTO $gm (num_ts,data,date,$f,$t) 
        VALUES('$num_form','$data','$date','$amount','$amount')") or die (mysqli_error($sss));
		
	
			}
			else{
$query = mysqli_query($sss, "INSERT INTO $gm (num_ts,data,date,$f) 
        VALUES('$num_form','$data','$date','$amount')") or die (mysqli_error($sss));
		
		$query = mysqli_query($sss, "INSERT INTO $gd (num_ts,data,date,$t) 
        VALUES('$num_form','$data','$date','$amount')") or die (mysqli_error($sss));
