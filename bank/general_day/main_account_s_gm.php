...
if(term!=""){
	 alert(term);
	 xmlhttp.open("GET","select_main_account_s_gm.php?q="+term,true);
xmlhttp.send();}
...
<form id="form1" name="form1" method="post" action="select_main_account_s_gm.php">
...
<caption><font size="+1">من تاريخ  </font></caption>
 <td>
  ...
  <table width="100%" align="right">
    <tr>
      <td  align="right"><label><font size="+1">حـسـاب الاستــخدامات الباب الاول
        <input type="radio" name="RadioGroup1" value="121" id="RadioGroup1_0" />
        </font></label></td>
    </tr>
    <tr>
      <td align="right"><label><font size="+1">حـسـاب الاستــخدامات الباب الثاني
        <input type="radio" name="RadioGroup1" value="122" id="RadioGroup1_1" />
        </font></label></td>
    </tr>
    <tr>
      <td align="right"><label><font size="+1">ححـسـاب الاستــخدامات الباب الثالث
        <input type="radio" name="RadioGroup1" value="123" id="RadioGroup1_2" />
        </font></label></td>
    </tr>
    </table></td>
	<td>
  <table width="100%" align="right">
    <tr>
      <td align="right"><label><font size="+1">حـسـاب الاستــخدامات الباب الربع
        <input type="radio" name="RadioGroup1" value="124" id="RadioGroup1_4" />
        </font></label></td>
    </tr>
    <tr>
      <td align="right"><label><font size="+1">حـسـاب الاستــخدامات الباب الخامس
        <input type="radio" name="RadioGroup1" value="125" id="RadioGroup1_5" />
       </font></label></td>
    </tr>
	</table></td></tr>
  </table>
