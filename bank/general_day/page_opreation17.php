 ...
 <table width="700" border="1" id="k"  style="visibility:hidden" >
  ...
  <table width="400" style="background-color:#9CF;" align="right">
	...
	<tr>
	 ...
	 <form name="form1" id="show1" style=" height:20px;visibility:hidden;" method="post"  action="opreation17.php">
...
<form  name="form1" id="show2" style="  height:20px;visibility:hidden;" method="post"  action="opreation17.php">
...
<form  name="form1" id="show3" style="  height:20px;visibility:hidden;" method="post"  action="opreation17.php">
...
<form  name="form1" id="show4" style="  height:20px;visibility:hidden;" method="post"  action="opreation17.php">
...
<form  name="form1" id="show5" style="  height:20px;visibility:hidden;" method="post"  action="opreation17.php">
...
<form  name="form1" id="show6" style="  height:20px;visibility:hidden;" method="post"  action="opreation17.php">
...
<form  name="form1" id="show7" style="  height:20px;visibility:hidden;" method="post"  action="opreation17.php">
...
<form  name="form1" id="show8" style="  height:20px;visibility:hidden;" method="post"  action="reportes_select8.php">
