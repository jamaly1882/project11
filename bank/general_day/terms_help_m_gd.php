  ...
  <table width="100%" align="right">
    <tr>
      <td  align="right"><label><font size="+1">حـسـاب  السـلف المؤقته
        <input type="radio" name="RadioGroup1" value="24" id="RadioGroup1_0" />
        </font></label></td>
    </tr>
    <tr>
      <td align="right"><label><font size="+1">حـسـاب  الأعتمادات المستندية
        <input type="radio" name="RadioGroup1" value="25" id="RadioGroup1_1" />
        </font></label></td>
    </tr>
    <tr>
      <td align="right"><label><font size="+1">حـسـاب المبالغ المدفوعة مقدما
        <input type="radio" name="RadioGroup1" value="26" id="RadioGroup1_2" />
        </font></label></td>
    </tr>
  ...
  <table width="100%" align="right">
    <tr>
      <td align="right"><label><font size="+1">حـسـاب التحويلات النقديه
        <input type="radio" name="RadioGroup1" value="27" id="RadioGroup1_4" />
        </font></label></td>
    </tr>
    <tr>
      <td align="right"><label><font size="+1">حساب السلف على الأجور
        <input type="radio" name="RadioGroup1" value="28" id="RadioGroup1_5" />
       </font></label></td>
    </tr>
    <tr>
      <td align="right"><label><font size="+1">حساب سلف الحسابات الجارية
        <input type="radio" name="RadioGroup1" value="29" id="RadioGroup1_6" />
        </font></label></td>
    </tr>
    <tr>
