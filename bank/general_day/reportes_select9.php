...
echo'<table width="100%" border="2" cellpadding="0" cellspacing="0">
     ...
     <tr>
      <td  colspan="7" rowspan="2" dir="RTL" align="center"><strong>صــفحـــــة    الــــعمـليـــــات </strong></td>
  </tr>
    <tr> </tr>
    <tr>
      <td align="center" colspan="3" dir="RTL" width="610"><strong>الجانب المدين (منه)</strong></td>
      <td align="center" rowspan="2" dir="RTL" width="469"><strong>بيان أنواع الحسابات</strong></td>
      <td align="center" colspan="3" dir="RTL" width="634"><strong>الجانب الدائن (لـــه)</strong></td>
    </tr>
    <tr>
      <td align="center" dir="LTR" width="610"><strong>الجملة</strong></td>
      <td align="center" dir="LTR" width="210"><strong>(الاشهر السابقة/المدة    السابقة)</strong></td>
      <td align="center" dir="LTR" width="220"><strong>الشهرالجاري    /المدة الجارية </strong></td>
      <td align="center" dir="LTR" width="634"><strong>الشهرالجاري    /المدة الجارية </strong></td>
      <td align="center" dir="LTR" width="229"><strong>(الاشهر السابقة/المدة    السابقة  )</strong></td>
      <td align="center" dir="LTR" width="180"><strong>الجملة</strong></td>
    </tr>
     ';
...
$sqlstatment5='SELECT `num_ts`, `num_s`, `year`, `month`, `day`, `data`, `term`, `type_account`, `accounts`, `resources`, `uses`, sum(`val`), `num_coll` FROM `public` WHERE  `year`="'.$year.'" And `month`="'.$monthinsert.'"  AND `type_account`="'.$i.'" AND`accounts` ="'.$num_account.'" AND `term`=2 ';
...
$sqlstatment6='SELECT  `year`, `month`, `term`, `type_account`, `accounts`, sum(`val`) FROM `public` WHERE  `year`="'.$year.'" And `month`="'.$monthinsert.'"  AND `type_account`="'.$i.'" AND`accounts` ="'.$num_account.'" AND `term`=1';
...
echo' 
  ...
  <td bgcolor="#AADFAA" style="background-color: font-weight: bold text-align: center; text-align: center;" dir="RTL">جملة الحساب</td>    <td dir="RTL">'.$jamlhaccountcurgm.'</td>
