...
if(term!=""){
	 alert(term);
	 xmlhttp.open("GET","select_main_account_ts_gd.php?q="+term,true);
xmlhttp.send();}
...
<form id="form1" name="form1" method="post" action="select_main_account_ts_gd.php">
...
<caption><font size="+1">من تاريخ  </font></caption>
 <td>
  ...
  <table width="100%" align="right">
    <tr>
      <td  align="right"><label><font size="+1">حـسـاب  الاستــخدامات
        <input type="radio" name="RadioGroup1" value="120" id="RadioGroup1_0" />
        </font></label></td>
    </tr>
    <tr>
      <td align="right"><label><font size="+1">المـــوارد الباب الاول
        <input type="radio" name="RadioGroup1" value="111" id="RadioGroup1_1" />
        </font></label></td>
    </tr>
	 <tr>
      <td align="right"><label><font size="+1">المـــوارد الباب الثاني
        <input type="radio" name="RadioGroup1" value="112" id="RadioGroup1_1" />
        </font></label></td>
    </tr>
	 <tr>
      <td align="right"><label><font size="+1">المـــواردالباب الثالث
        <input type="radio" name="RadioGroup1" value="113" id="RadioGroup1_1" />
        </font></label></td>
    </tr>
	 <tr>
      <td align="right"><label><font size="+1"> المـــوارد الرابع
        <input type="radio" name="RadioGroup1" value="114" id="RadioGroup1_1" />
        </font></label></td>
    </tr>
	 <tr>
      <td align="right"><label><font size="+1">المـــوارد الخامس
        <input type="radio" name="RadioGroup1" value="115" id="RadioGroup1_1" />
        </font></label></td>
    </tr>
    <tr>
      <td align="right"><label><font size="+1">حـسـاب  البنك الموارد
        <input type="radio" name="RadioGroup1" value="130" id="RadioGroup1_2" />
        </font></label></td>
    </tr>
    </table></td>
	<td>
