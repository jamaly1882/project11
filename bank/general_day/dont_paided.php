...
<?php
echo' <form action="insert_paided.php" method="post"><table width="700" border="1" >
  ...
  <td style="width:850px">البــــيــــان</td>
    <td style="width:100px">السنه</td>
	 ...
	 <td style="width:150px">رقــم الاستمارة</td>
  </tr>
   <tr  valign="top">
  ...
  <tr  align="center"  valign="top">
   <td colspan="2"> <select name="" onchange="getaccount2(this.value);"  style="font-size:18px;"  class="TabbedPanelsTabHover"  >
     ...
     <option value="32">حساب المبالغ الدئنة تحت التسوية</option>
    </select></td>
 ...
 <input type="text" name="name_ac_gm" id="gmss" value=""/>
<input type="text" name="name_ac_gd" id="gdss" value=""/>
<input type="text" name="resources" id="resources" value=""/>
<input type="text" name="termgm" id="termgm" value=""/>
<input type="text" name="termgd" id="termgd" value=""/>
<input type="text" name="uses" id="uses" value=""/> 
