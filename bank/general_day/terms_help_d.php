  ...
  <table width="200" style="background-color:#9CF;" align="right">
    <tr>
      <td align="right"><label><font size="+1">حـسـاب الحـسـابات الجارية
        </font><input type="checkbox" name="CheckboxGroup1" value="c_ac" id="Check0" />
        </font></label></td>
    </tr>
    <tr>
      <td align="right"><label><font size="+1">الدائـــنين ماليه
        </font><input type="checkbox" name="CheckboxGroup1" value="danine_maliah" id="Check1" />
        </label></td>
    </tr>
    <tr>
      <td align="right"><label><font size="+1">المبالغ الدائنه تحت التسوية
       </font> <input type="checkbox" name="CheckboxGroup1" value="money_under_ts" id="Check2" />
        </label></td>
    </tr>
  </table>
