...
if(term!=""){
	 alert(term);
	 xmlhttp.open("GET","select_main_account_ts_gm.php?q="+term,true);
xmlhttp.send();}
...
<form id="form1" name="form1" method="post" action="select_main_account_ts_gm.php">
...
<caption><font size="+1">من تاريخ  </font></caption>
 <td>
  ...
  <table width="100%" align="right">
    <tr>
      <td  align="right"><label><font size="+1">حـسـاب  البنك الاستــخدامات
        <input type="radio" name="RadioGroup1" value="140" id="RadioGroup1_0" />
        </font></label></td>
    </tr>
    <tr>
      <td align="right"><label><font size="+1">الموارد
        <input type="radio" name="RadioGroup1" value="110" id="RadioGroup1_1" />
        </font></label></td>
    </tr>
    <tr>
