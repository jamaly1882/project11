...
<form id="form1" name="form1" method="post" action="report_dine_month.php" bgcolor="#339966">
 <table width="700" border="1"   bgcolor="#9CF">
 <tr  align="center"  valign="top">
   <td colspan=""> 
    <label> <input name="r" type="text" size="25"dir="rtl" id="report_dine_monthe"    onchange="report_d_month(this.value)" value=""/> <font size="+1">السنه  </font>
  </label></td>

  <td colspan=""> 
   <input name="q" type="hidden"  id="month_dine" size="25" dir="rtl"/>
