...
<form id="form5" name="form5" method="post"  action="report_nhai.php" bgcolor="#9CF">
<div >
 <table width="700" border="1"   bgcolor="#9CF">
 <tr  align="center"  valign="top">
   <td colspan=""> 
    <label> <input name="p" type="text" size="25" dir="rtl" id="report_h_month11" value=""  onchange="report_h_month(this.value)" /> <font size="+1">السنه  </font>
  </label></td>

  <td colspan=""> 
   <input name="q" type="hidden"  id="report_nhi_month1" size="25"  dir="rtl"/>
