...
$q =$_GET['q'];// filter everything but numbers for security
// Query the body section for the proper page
//include_once "../scripts/connect_to_mysql.php";
echo $q;
$sqlCommand = "SELECT astmid, bain, deta,  babid,  faslid ,  bandid ,  typeid ,  sum  FROM  data WHERE astmid='$q' ";
   ...
   <table width="100%"  align="center" height="80" border="1"  bgcolor=""  >
                        ...
                        <tr>
                         <td  bgcolor="#FFFFFF" >'.$row["sum"].'</td>
                          <td  bgcolor="#FFFFFF"  width="97" align="center"> '.$row["typeid"].'</td>
                          <td bgcolor="#FFFFFF"  width="93" align="center">'. $row["bandid"].'</td>
