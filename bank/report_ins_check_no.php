...
<form id="form5" name="form5" method="post"   action="report_check_noserf.php"  bgcolor="#9CF">
<div >
 ...
 <tr  align="center"  valign="top">
  ...
  <td colspan=""> 
   <input name="q" type="hidden"  id="report_check_n" size="25"  dir="rtl"/>
   
   
	 <select   onchange="check_no_serf(this.value)" name="r"dir="rtl" >
 ...
 <option value="12">شهر ديسمبر</option>
				 ...
				 <td colspan=""> 
    <label> <input name="q" type="text" size="25" dir="rtl" id="report_check_n2" value=""  onchange=" report_check_nose(this.value)" /> <font size="+1">القيمة  </font>
  </label></td>
				</tr>
				</table>
